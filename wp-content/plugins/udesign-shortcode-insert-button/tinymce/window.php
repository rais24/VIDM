		...
		// which tab is active ?
                if (ibMiscellaneous.className.indexOf('current') != -1) {
                        ...
                        // Tabs
                            ...
                            shortcodetext = '[udesign_recent_posts title="Recent Posts" category_id="1" num_posts="3" post_offset="0" num_words_limit="23" show_date_author="0" show_more_link="0" more_link_text="Read more" show_thumbs="1" thumb_frame_shadow="1" post_thumb_width="100" post_thumb_height="80"]';
                        }
