...
class UDesignWooCommerce {
	...
	protected function udesign_woocommerce_enqueue_plugin_files() {
            wp_enqueue_style('u-design-woocommerce-styles', $this->plugin_url . '/css/udesign-woocommerce-style.css', false, '2.1.5');
            global $udesign_options;
            if ( $udesign_options['enable_responsive'] ) {
                wp_enqueue_style('u-design-woocommerce-responsive', $this->plugin_url . '/css/udesign-woocommerce-responsive.css', false, '2.1.5');
            }
        }
        ...
        public function udesign_woocommerce_plugin() {
                ...
                // WooCommerce -> Settings ->  Scripts (Enable Lightbox)
                ...
                function woocommerce_breadcrumb( $args = array() ) {
                        ...
                        $defaults = apply_filters( 'woocommerce_breadcrumb_defaults', array(
                                ...
                                'wrap_before'  => '<div class="container_24"><div id="wc-breadcrumbs" ' . ( is_single() ? 'itemprop="breadcrumb"' : '' ) . '>',
                                'wrap_after' => '</div></div>',
                                'before'   => '',
                                'after'   => '',
