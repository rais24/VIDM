...
function udesign_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'   		=> get_stylesheet_directory() . '/lib/plugins/udesign-shortcode-insert-button.zip', // The plugin source
			'required' 		=> false, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			...
			'source'   		=> get_stylesheet_directory() . '/lib/plugins/u-design-woocommerce.zip', // The plugin source
			'required' 		=> false, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			...
			'source'   		=> get_stylesheet_directory() . '/lib/plugins/flickr-rss.zip', // The plugin source
			'required' 		=> false, // If false, the plugin is only 'recommended' instead of required
		...
		array(
                        ...
                        'source'                => get_stylesheet_directory() . '/lib/plugins/envato-wordpress-toolkit.zip', // The plugin source
			'required' 		=> false, // If false, the plugin is only 'recommended' instead of required
