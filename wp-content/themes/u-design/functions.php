...
define( 'UDESIGN_VERSION', '2.4.19' );

// Redirect user to the "U-Design" theme settings page after activatio
...
function udesign_init_styles() {
	...
	wp_enqueue_style('u-design-style', get_bloginfo('template_url') . "/styles/style1/css/style.css", false, UDESIGN_VERSION, 'screen');
        ...
        if ( get_theme_mod( 'udesign_custom_styles_use_css_file' ) ) { // load "custom_style.css" file
            ...
            wp_enqueue_style('u-design-custom-style', get_bloginfo('template_url') . '/styles/custom/custom_style.css', false, UDESIGN_VERSION.$rand_ver, 'screen');
        } else { // otherwise use "custom_style.php" file
            wp_enqueue_style('u-design-custom-style', get_bloginfo('template_url') . '/styles/custom/custom_style.php', false, UDESIGN_VERSION, 'screen');
        }
        
        if ( $udesign_responsive ) {
            wp_enqueue_style('u-design-responsive', get_bloginfo('template_url') . '/styles/common-css/responsive.css', false, UDESIGN_VERSION, 'screen');
        }
        if ( $udesign_options['max_theme_width'] || $udesign_options['global_theme_width'] > 960 || 
            ...
            wp_enqueue_style('u-design-fluid', get_bloginfo('template_url') . '/styles/common-css/fluid.css', false, UDESIGN_VERSION, 'screen');
        }
...
if ( $udesign_options['enable_feedback'] ) {
    function udesign_feedback_button() {
        global $udesign_options;
        ob_start(); ?>
            <div id="feedback"><a href='#<?php //echo $udesign_options['feedback_url']; ?>' title="<?php esc_attr_e('Feedback', 'udesign'); ?>" class="feedback eModal-1" ></a></div>
<?php
...
if( function_exists('vc_set_as_theme') ) {
    add_action( 'init', 'udesign_vc_set_as_theme' );
